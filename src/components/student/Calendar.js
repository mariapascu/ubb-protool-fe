...
var intervals = [{ title: "Lab LFTC", prof: "S Motogna", type: "Laboratory", location: "L302", start: moment({ month: 6, day: 1, year: 2019, h: 8 }), end: moment({ month: 6, day: 1, year: 2019, h: 10 }) },
