...
const c2=new CourseClass(2,teacherss[5],co[2],subgroups[7],"Seminar",2,0,10,"C001",2)
...
const c7=new CourseClass(7,teacherss[4],co[0],subgroups[6],"Seminar",5,0,10,"C512",1)
